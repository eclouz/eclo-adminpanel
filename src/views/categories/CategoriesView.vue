...
<template>
    ...
    <div class="grid justify-items-end ...">
        <button type="button"
                class="mb-4 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-green-300 font-medium rounded-lg text-sm px-3 py-3 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">+
                Add Category</button>
    </div>
