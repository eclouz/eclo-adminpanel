        ...
        this.subCategoryList = response.data;
          ...
          async submitForm() {            
            const token = getToken();  
                ...
                try {
                    const response = await axios.put('api/admin/products/' + this.productId, { "BrandId": this.brandId ,
...
<div class="mb-1" style="width: 45%;" >
    ...
    <input placeholder="Write product name" v-model="name" type="text" id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
...
<div class="mb-1" style="width: 45%;">
    ...
    <input placeholder="Write product price . . ." v-model="unitPrice" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">    
</div>
