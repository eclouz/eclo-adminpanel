...
<template>
    ...
    <nav class="flex mb-5" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
            <div class="flex items-center" v-for="item in items" :key="item.path">
                <svg class="w-3 h-3 text-gray-400 mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"/>
                </svg>
                <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white"> {{ item.path }}</a>
            </div>
            </li>
            ...
            <button type="button" disabled
                ...
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                    ...
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <rect fill="currentColor" opacity="0.3" x="11.5" y="2" width="2" height="4" rx="1" />
                        <rect fill="currentColor" opacity="0.3" x="11.5" y="16" width="2" height="5" rx="1" />
                        <path
