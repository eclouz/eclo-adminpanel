...
export default defineComponent({
    ...
    methods: {
        ...
        async deleteDataAsync(id:any){
            ...
            await axios.delete("api/product/detail/fashions/" + id,{
                headers:{
...
<template>        
<div    :id-prop=Id
        :prodcutDetail-prop-prop=ProductDetailId
...
<style>
</style>@/Helpers/DateHelper@/Helpers/TokenHelper@/helpers/TokenHelper