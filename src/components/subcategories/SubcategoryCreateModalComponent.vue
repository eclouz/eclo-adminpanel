...
<template>
    ...
    <div class="grid justify-items-end ...">
        <button @click="selectAsync" data-modal-target="create-modal" data-modal-toggle="create-modal"
            class="m-3 block text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-full text-sm px-2 py-2 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
            type="button">
